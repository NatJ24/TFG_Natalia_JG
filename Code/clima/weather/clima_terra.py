...
atributos_weather = carla.WeatherParameters(
    ...
    wind_intensity=60.0,            # Viento intenso (tpico del Terral)
    fog_density=5.0,                # Ligero efecto trmico
    fog_distance=100.0,             # Buena visibilidad
    fog_falloff=0.2,                # Transicin muy suave de la niebla
    wetness=5.0,                    # Superficies secas
    scattering_intensity=0.4,       # Ligera distorsin en la luz
    ...
    sun_altitude_angle=55.0         # Sol alto pero ms clido
)
