...
atributos_weather = carla.WeatherParameters(
    ...
    wind_intensity=20.0,            # Viento suave que arrastra partículas
    fog_density=20.0,               # Densidad visible de calima
    fog_distance=40.0,              # Visibilidad reducida
    fog_falloff=0.8,                # Cae rápidamente la visibilidad a distancia
    wetness=10.0,                   # Ligeramente húmedo
    scattering_intensity=0.7,       # Luz muy dispersa (efecto neblinoso)
    mie_scattering_scale=0.2,       # Alta dispersión por polvo (calima)
    rayleigh_scattering_scale=0.02, # Menos azul, cielo más blanquecino/ocre
